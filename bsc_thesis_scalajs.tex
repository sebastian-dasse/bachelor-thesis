...
\section{minimierter/optimierter Produktionscode} (mit Google Closure Compiler  -->  https://developers.google.com/closure/compiler/)
...
\begin{figure}[h]
	...
	\subfloat[][Kurz nach Start.]{
		\includegraphics[width=0.46\textwidth]{03canvas-frenzy/frenzy-snap01}
		\label{fig:frenzy1}
	}
	\quad
	\subfloat[][Nachdem etwas Zeit vergangen ist.]{
		\includegraphics[width=0.46\textwidth]{03canvas-frenzy/frenzy-snap02}
		\label{fig:frenzy2}
	}
	\qquad
	\subfloat[][Zeichnen mit Gradienten-Stift bei angehaltenem Auto-Zeichnen.]{
		\includegraphics[width=0.46\textwidth]{03canvas-frenzy/frenzy-snap03}
		\label{fig:frenzy3}
	}
	\quad
	\subfloat[][Auto-Zeichnen und Gradienten-Stift.]{
		\includegraphics[width=0.46\textwidth]{03canvas-frenzy/frenzy-snap04}
		\label{fig:frenzy4}
	}
